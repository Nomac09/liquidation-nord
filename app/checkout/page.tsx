  ...
  if (!ready || !clientSecret) {
    return (
      <div className="container mx-auto flex min-h-[50vh] items-center justify-center px-4">
        <p className="font-mono text-[11px] uppercase tracking-widest text-dust">Chargement du paiement…</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-stone">
      <div className="container mx-auto max-w-2xl px-4 py-8">
        <Link href="/cart" className="mb-6 inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-widest text-dust hover:text-ink">
          <ChevronLeft aria-hidden className="h-3.5 w-3.5" />
          Retour au panier
        </Link>

        <div className="overflow-hidden rounded-xl border border-hairline bg-surface shadow-carte">
