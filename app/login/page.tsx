  ...
  return (
    <div className="container mx-auto max-w-sm px-4 py-16">
      ...
      <button
        ...
        className="mt-6 flex w-full items-center justify-center gap-2 rounded-full border border-ligne bg-blanc py-3 text-sm font-semibold text-encre transition-colors hover:border-gris"
      >
      ...
      <p className="mt-6 text-center text-sm text-gris">
        ...
        <Link href={`/register?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="font-semibold text-bleu hover:underline">
          Créer un compte
        </Link>
      </p>
    </div>
